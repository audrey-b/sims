...
"
  ...
  expect_equal(sims_simulate(generative_model, 
               ...
               structure(list(C = c(43, 20, 25, 26, 24), lambda = c(32.0212581683725, 
                                                                    29.2301292225158, 26.6822886806137, 24.3565303394963, 22.2334964320294
               ), rand = -0.432496093743802, Year = 1:5), class = "nlist"), 
               structure(list(C = c(30, 30, 29, 27, 18), lambda = c(32.0212581683725, 
                                                                    29.2301292225158, 26.6822886806137, 24.3565303394963, 22.2334964320294
               ), rand = 0.330592435921736, Year = 1:5), class = "nlist")), class = "nlists"))
})
...
test_that("nsims > 1",{
  ...
  expect_equal(sims_simulate("a ~ dunif(0,1)", nsims = 2L),
               structure(list(structure(list(a = 0.247694617962275), class = "nlist"), 
                              structure(list(a = 0.042773205241931), class = "nlist")), class = "nlists"))
  set.seed(101)
  expect_equal(sims_simulate("a ~ dunif(0,1)", nsims = 2L),
               structure(list(structure(list(a = 0.247694617962275), class = "nlist"), 
                              structure(list(a = 0.042773205241931), class = "nlist")), class = "nlists"))
...
test_that("write replicable > 1",{
  ...
  expect_equal(readRDS(file.path(tempdir, "data0000001.rds")),
               structure(list(a = 0.22130195651164), class = "nlist"))
  expect_equal(readRDS(file.path(tempdir, "data0000002.rds")),
               structure(list(a = 0.99224542279915), class = "nlist"))
  set.seed(101)
  expect_true(sims_simulate("a ~ dunif(0,1)", nsims = 1L, path = tempdir, exists = TRUE))
  expect_equal(readRDS(file.path(tempdir, "data0000001.rds")),
               structure(list(a = 0.247694617962275), class = "nlist"))
...
test_that("parallel with registered", {
  ...
  set.seed(101)
  expect_equal(sims_simulate("a ~ dunif(0,1)", nsims = 1L, parallel = FALSE),
                   structure(list(structure(list(a = 0.247694617962275), class = "nlist")), class = "nlists"))
# 
#   set.seed(101)
#   expect_equal(sims_simulate("a ~ dunif(0,1)", nsims = 1L, parallel = TRUE),
#                    structure(list(structure(list(a = 0.247694617962275), class = "nlist")), class = "nlists"))
# 
#   set.seed(101)
